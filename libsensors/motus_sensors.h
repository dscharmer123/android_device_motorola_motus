...
typedef struct {
    ...
    union {
        ...
        /* rotation (0..3). using float as SensorListener returns only array of floats */
        float           rotation;
    };
...
struct sensors_control_device_t {
     ...
     */
    int (*open_data_source)(struct sensors_control_device_t *dev, int sensor);
...
struct sensors_data_device_t {
     ...
     * @return 0 if successful, < 0 on error
     */
    int (*data_open)(struct sensors_data_device_t *dev, int fd, int sensor);
